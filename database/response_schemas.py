...
class ProjectResponse(BaseModel):
    """Basic project schema without relationships"""
    id: int
    repo_name: str
    owner_name: str
...
class ProjectWithUserResponse(ProjectResponse):
    """Project schema including owner information"""
    user_name: str
    user_email: str
...
# Project response type aliases
ProjectCreateResponse = DataResponse[ProjectResponse]
ProjectUpdateResponse = DataResponse[ProjectResponse]
ProjectDeleteResponse = BaseResponse
ProjectDetailResponse = DataResponse[ProjectWithUserResponse]
ProjectListResponse = ListResponse[ProjectWithUserResponse]