...
from routes.github_auth_router import github_auth_router
...
app.include_router(github_auth_router, prefix="/api/v1") # Route GitHub authentication endpoints (OAuth)
app.include_router(project_router, prefix="/api/v1") # Route for working with "projects"
